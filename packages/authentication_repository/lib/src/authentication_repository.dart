...
class AuthenticationRepository {
  ...
  Future<bool> checkEmailVerified() async {
    try {
      ...
      // print ('Verified User: $firebaseUser');
...
extension on firebase_auth.User {
  ...
  User get toUser {
    return User(id: uid, email: email, name: displayName, photo: photoURL, emailVerified: emailVerified, metadata: metadata, phoneNumber: phoneNumber, providerData: providerData);
  }
}
